...
Um ein wert- und zeitkontinuierliches Signal zu digitalisieren, wird es in zwei Schritten verarbeitet:
...
\end{axis}
\end{tikzpicture}
\caption{Abtastung: Aus dem kontinuierlichen Signal (blau) werden in Abständen $T_A$ Werte entnommen (rot).}
\end{figure}
