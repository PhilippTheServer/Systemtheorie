...
Dieses Skript ist ein persönliches Begleitdokument zur Vorlesung
\textbf{Systemtheorie – Signale und Systeme~I} im Sommersemester~2026.
Es entstand als mathematisch strukturierte Mitschrift mit dem Ziel, die
zentralen Konzepte und Methoden der Signalverarbeitung und Systemanalyse
kompakt und nachvollziehbar festzuhalten.

\bigskip

\begin{bemerkungbox}[Hinweis zur Nutzung]
Das Skript ist kein offizielles Lehrwerk und ersetzt weder die Vorlesung noch
die Originalunterlagen. Fehler, Unvollständigkeiten und persönliche Ergänzungen
sind möglich – für Korrekturen ist der Autor dankbar.
\end{bemerkungbox}
